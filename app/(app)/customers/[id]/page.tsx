    ...
    return (<section className="page narrow-page">
      ...
      <section className="panel">
        <form action={updateCustomerAction} className="stack-form compact-form">
          ...
          <label>Nome<input required name="name" maxLength={140} defaultValue={customer.name}/></label>
          <label>Telefone <small>opcional</small><input name="phone" maxLength={40} inputMode="tel" defaultValue={customer.phone ?? ""}/></label>
          <label>Endereço <small>opcional</small><textarea name="address" maxLength={500} rows={3} defaultValue={customer.address ?? ""}/></label>
          <label>Observações <small>opcional</small><textarea name="notes" maxLength={2000} rows={3} defaultValue={customer.notes ?? ""}/></label>
